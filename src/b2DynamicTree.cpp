...
int32 b2DynamicTree::CreateProxy(const b2AABB& aabb, ee::ShadowLine line)
{
...
{
    int32 * nodes = new int32[m_nodeCount];
    int32 count = 0;
...
ee::ShadowLine b2DynamicTree::GetNthShadowLine(int32 index)
{
